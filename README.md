...
<img src="art/banner.svg" alt="V2TunClient" width="100%"/>
...
| 🔐 | **`.arasc` encrypted sharing** — export & import configs in V2TunClient's own secure container, with optional password protection |
...
V2TunClient's own encrypted container for configs and subscriptions.
...
- **Export**: Menu → *Export* → pick subscriptions/configs → Normal or Protected → save `V2TunClient-Configs.arasc`
- **Import**: tap **+** → *Import .arasc file* — or just tap the file in any file manager and pick V2TunClient
